...
class Message(models.Model):
    ...
    sender = models.ForeignKey(AUTH_USER_MODEL, related_name='django_sent_messages', verbose_name=_("Sender"), on_delete=models.PROTECT)
    recipient = models.ForeignKey(AUTH_USER_MODEL, related_name='django_received_messages', null=True, blank=True, verbose_name=_("Recipient"), on_delete=models.SET_NULL)
